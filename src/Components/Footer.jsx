export default function Footer() {
  return (
    <div className="relative w-full flex flex-col justify-center items-center h-[100px] pb-10 md:pb-0 mb-10 md:mb-0">
      <div className="text-indigo-200/90 flex flex-col-reverse md:flex-row gap-5 justify-between items-center max-w-5xl w-screen">
        ...
        <a
          ...
          className="relative border-animation-2 bg-slate-950/50 hover:bg-indigo-900/60 overflow-visible  px-4 py-2 rounded-md cursor-pointer hover:outline-indigo-300 outline outline-transparent hover:outline-2 transition-all outline-offset-2 duration-300 font-bold"
        >
          Download My Resume
        </a>
      </div>
