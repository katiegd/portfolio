              ...
              <div key={category.name} className="flex flex-col gap-2 items-center w-fit">
                ...
                <div className="flex flex-wrap gap-2 justify-center">
                  {tech[categoryIndex][category.key].map((item, itemIndex) => (
                    <div
                      className="flex gap-4 items-center  bg-gradient-to-br from-indigo-100/20 to-indigo-300/20 backdrop-blur-sm shadow-md border border-violet-400/15 text-slate-100 md:px-5 md:py-2 px-3 py-1 rounded-full"
