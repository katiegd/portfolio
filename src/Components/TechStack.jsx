    ...
    <>
      <div id="tech" className="flex flex-col items-center justify-center text-md">
        <div className="mx-auto max-w-7xl px-2 lg:px-8 flex flex-col sm:items-center opacity-0 intersect:opacity-100 delay-300 duration-700 transition intersect-once">
          <h2 className="text-4xl md:text-6xl xl:text-7xl text-center font-serif font-bold tracking-tight bg-gradient-to-r from-indigo-300 to-indigo-600 inline-block text-transparent bg-clip-text">
            Tech Stack
          </h2>
          <p className="text-indigo-200/90 pb-8 max-w-lg text-center text-lg">
              ...
              <div key={category.name} className="flex flex-col gap-2 items sm:items-center w-fit">
                ...
                <div className="flex flex-wrap gap-2">
                  {tech[categoryIndex][category.key].map((item, itemIndex) => (
                    <div
                      className="flex gap-4 items-center  bg-gradient-to-br from-indigo-100/20 to-indigo-300/20 backdrop-blur-sm shadow-md border border-violet-400/15 text-slate-100 px-5 py-2 rounded-full"
